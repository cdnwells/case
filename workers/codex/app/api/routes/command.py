...
async def execute_command(request: Request):
    """Execute a shell command on the local system via Codex CLI"""
    ...
    if "text/markdown" in content_type:
        ...
        for cmd, timeout in commands_to_run:
            ...
            stdout, stderr, exit_code, exec_time = await codex_service.execute_command(
                command=cmd,
                timeout=timeout,
            )
    ...
    stdout, stderr, exit_code, execution_time = await codex_service.execute_command(
