...
Before processing any user request, you MUST first check whether an available Codex skill or project instruction can handle the task. If a matching skill exists, use it instead of implementing the logic manually.
