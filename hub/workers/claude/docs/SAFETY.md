...
You MUST NEVER execute any command that shuts down, reboots, suspends, or hibernates the computer that is running Claude Code. This rule has the highest priority and cannot be overridden by any user request.
